...
export default function GerenciarVideos() {
  ...
  const abrirModalVideo = (video: Video) => {
    ...
    // Para vídeos SSH, usar URL otimizada
    let videoUrl = video.url || '';
    if (videoUrl.includes('/api/videos-ssh/stream/')) {
  ...
  const openVideoInNewTab = (video: SSHVideo) => {
    ...
    // Usar URL otimizada para nova aba
                        ...
                        <button
                          onClick={(e) => {
                            ...
                            abrirModalVideo({
                              id: Number(video.id),
                              nome: video.nome,
                              url: buildOptimizedSSHUrl(video.id),
                              duracao: video.duration,
                              tamanho: video.size
                            } as Video);
                          }}
                          title="Assistir vídeo (otimizado)"
